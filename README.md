...
- [AI Models](#ai-models) (7) — Repositories focused on developing and training various AI models, including language models and visual models.
- [Reinforcement Learning](#reinforcement-learning) (2) — Projects that implement reinforcement learning algorithms and frameworks for enhancing decision-making capabilities.
- [Natural Language Processing](#natural-language-processing) (3) — Tools and frameworks dedicated to processing and understanding human language, including translation and text generation.
...
- [Data Science](#data-science) (2) — Projects that involve data integration, analysis, and visualization across various domains.
- [Automation Tools](#automation-tools) (3) — Tools designed for automating tasks, including browser automation and document processing.
- [Creative Tools](#creative-tools) (7) — Repositories that provide tools for creative processes, such as writing, storytelling, and content generation.
- [Agent Frameworks](#agent-frameworks) (9) — Frameworks and systems designed for building intelligent agents that can perform tasks autonomously.
- [Web Development](#web-development) (2) — Projects that focus on web applications, including tools for enhancing web interactions and user experiences.
- [3D Modeling & Mapping](#3d-modeling-mapping) (1) — Repositories that provide tools for 3D modeling, mapping, and urban analysis.
- [Other](#other) (11) — Repositories that do not fit into the above categories.
...
**⭐ Stars:** 490 | **🍴 Forks:** 91 | **📅 Updated:** 2026-04-08
...
## Reinforcement Learning (Total 2)
...
> Tools and frameworks dedicated to processing and understanding human language, including translation and text generation.
...
## Creative Tools (Total 7)

> Repositories that provide tools for creative processes, such as writing, storytelling, and content generation.
...
## Agent Frameworks (Total 9)

> Frameworks and systems designed for building intelligent agents that can perform tasks autonomously.
...
## Web Development (Total 2)

> Projects that focus on web applications, including tools for enhancing web interactions and user experiences.
...
---
<a id="3d-modeling-mapping"></a>
## 3D Modeling & Mapping (Total 1)

> Repositories that provide tools for 3D modeling, mapping, and urban analysis.
